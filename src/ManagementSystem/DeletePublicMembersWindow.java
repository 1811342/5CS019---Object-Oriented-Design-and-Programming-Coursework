/**
 * Delete Public Memebr GUI
 * */

package ManagementSystem;
public class DeletePublicMembersWindow extends javax.swing.JFrame {

    /**
     * Creates new form DeleteSchoolMemberWindow
     */
    public DeletePublicMembersWindow() {
        initComponents();
    }
    ...
    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        PublicMemberList Sml = new PublicMemberList();
        Sml.DeletePublicMembers(id);
    }
    ...
    private void FindActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        PublicMemberList Sml = new PublicMemberList();
        Sml.readCSV();
        PublicMember Memebr = Sml.findById(id);

        if (Memebr==null){
            TextFilde.setText("Can not Find the Member");
            Delete.setEnabled(false);
        }else{
            TextFilde.setText("Do you want to remove "+Memebr.getName().getFullName());
