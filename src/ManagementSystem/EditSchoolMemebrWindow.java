...
import javax.swing.*;
public class EditSchoolMemebrWindow extends javax.swing.JFrame {
    /**
     * Creates new form EditMemebrsWindow
     */
    public EditSchoolMemebrWindow() {
        initComponents();
    }
    ...
    private void EditActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(newName.getText().isEmpty()||newAge.getText().isEmpty()||newPhone.getText().isEmpty()||newEmail.getText().isEmpty()){
            ...
            slist.EditSchoolMembers(Id,newName.getText(),newAge.getText(),newPhone.getText(),newEmail.getText());
    ...
    private void FindActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (foundStudentMember == null){
            ...
            oldemail.setText(foundStudentMember.getEmail());
            oldPhone.setText(foundStudentMember.getPhone());
            oldName.setText(foundStudentMember.getName().getFullName());
            OldAge.setText(foundStudentMember.getAge());
